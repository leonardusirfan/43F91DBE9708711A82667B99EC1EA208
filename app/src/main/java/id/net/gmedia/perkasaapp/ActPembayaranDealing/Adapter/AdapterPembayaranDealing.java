...
public class AdapterPembayaranDealing extends RecyclerView.Adapter<AdapterPembayaranDealing.PiutangViewHolder> {

    private List<CustomItem> listOutlet;
    private ItemValidation iv = new ItemValidation();
    private Context context;

    public AdapterPembayaranDealing(List<CustomItem> listOutlet, Context context){
    ...
    public PiutangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_pembayaran, parent, false);
    ...
    public void onBindViewHolder(@NonNull PiutangViewHolder holder, int position) {
        ...
        holder.cvContainer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, DetailPembayaranDealing.class);
