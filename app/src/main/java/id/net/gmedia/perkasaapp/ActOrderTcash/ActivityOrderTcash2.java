...
import id.net.gmedia.perkasaapp.ActOrderTcash.Adapter.AdapterOrderTcash;
...
public class ActivityOrderTcash2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getSupportActionBar() != null){
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Reseller Tcash");
        }
    ...
    private void initEvent() {
        ...
        lvReseller.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(item != null){
                    Intent intent = new Intent(context, ActivityOrderTcash3.class);
