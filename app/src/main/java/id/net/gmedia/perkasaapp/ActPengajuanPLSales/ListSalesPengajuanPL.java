...
public class ListSalesPengajuanPL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_sales_pengajuan_pl);
    ...
    private void initEvent() {
        ...
        lvSales.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(context, DetailPengajuanPlafon.class);
                intent.putExtra("nik", item.getItem1());
