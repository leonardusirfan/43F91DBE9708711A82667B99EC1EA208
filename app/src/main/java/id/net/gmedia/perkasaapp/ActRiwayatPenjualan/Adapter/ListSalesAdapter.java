package id.net.gmedia.perkasaapp.ActRiwayatPenjualan.Adapter;
...
public class ListSalesAdapter extends ArrayAdapter{
    ...
    public ListSalesAdapter(Activity context, List<CustomItem> items) {
        super(context, R.layout.adapter_list_sales, items);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.adapter_list_sales, null);
