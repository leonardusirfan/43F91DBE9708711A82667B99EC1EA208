...
import id.net.gmedia.perkasaapp.ActKunjungan.Adapter.ListResellerKunjunganAdapter;
import id.net.gmedia.perkasaapp.R;
import id.net.gmedia.perkasaapp.Utils.ServerURL;

public class ActivityKunjunganOutlet extends AppCompatActivity implements LocationListener {
    ...
    private boolean isUpdateLocation = false, isDataLoaded = false;
    ...
    private ListResellerKunjunganAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle("Detail Penjualan Perdana");
        context = this;
    ...
    private void initUI() {
        ...
        dialogBox = new DialogBox(context);
        edtSearch = (EditText) findViewById(R.id.txt_cari);
        lvOutlet = (ListView) findViewById(R.id.lv_outlet);
        ...
        lvOutlet.addFooterView(footerList);
        adapter = new ListResellerKunjunganAdapter((Activity) context, listItems);
        lvOutlet.removeFooterView(footerList);
        lvOutlet.setAdapter(adapter);

        lvOutlet.setOnScrollListener(new AbsListView.OnScrollListener() {
            @Override
            public void onScrollStateChanged(AbsListView absListView, int i) {

                int threshold = 1;
                int total = lvOutlet.getCount();

                if (i == SCROLL_STATE_IDLE) {
                    if (lvOutlet.getLastVisiblePosition() >= total - threshold && !isLoading) {
    ...
    private void initData(){
        ...
        ApiVolley request = new ApiVolley(context, jBody, "POST", ServerURL.getResellerKunjungan, new ApiVolley.VolleyCallback() {
            @Override
        ...
        mSettingsClient.checkLocationSettings(mLocationSettingsRequest)
                .addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) {
                        ...
                        if (ActivityCompat.checkSelfPermission(ActivityKunjunganOutlet.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ActivityKunjunganOutlet.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        ...
                        mFusedLocationClient.getLastLocation()
                                .addOnSuccessListener(ActivityKunjunganOutlet.this, new OnSuccessListener<Location>() {
                                    @Override
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(ActivityKunjunganOutlet.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(ActivityKunjunganOutlet.this, errorMessage, Toast.LENGTH_LONG).show();
                                mRequestingLocationUpdates = false;
                                //refreshMode = false;
                        }
    ...
    public Location getLocation() {
        ...
        try {
            ...
            if (isGPSEnabled == false && isNetworkEnabled == false) {
                ...
                Toast.makeText(ActivityKunjunganOutlet.this, "Cannot identify the location.\nPlease turn on GPS or turn on your data.",
                ...
                if (isNetworkEnabled) {
                    ...
                    if (ActivityCompat.checkSelfPermission(ActivityKunjunganOutlet.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(ActivityKunjunganOutlet.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                        if (ActivityCompat.shouldShowRequestPermissionRationale(ActivityKunjunganOutlet.this,
    ...
    private void requestPermission(String permissionName, int permissionRequestCode) {
        ActivityCompat.requestPermissions(ActivityKunjunganOutlet.this,
    ...
    public void onLocationChanged(Location clocation) {
        ...
        if(!isUpdateLocation && !isDataLoaded){
