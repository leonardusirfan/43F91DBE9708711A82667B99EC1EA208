...
public class ChatAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.tvTime.setText(iv.ChangeFormatDateString(item.getItem5(), FormatItem.formatTimestamp, FormatItem.formatDateTimeDisplay));
        ...
        if(extension.length() > 0 && iv.isImage(extension)){ // image
            ...
            iu.LoadRealImage(context, item.getItem11(), holder.ivImage);
