...
public class AdapterRekonsinyasi extends RecyclerView.Adapter<AdapterRekonsinyasi.PiutangViewHolder> {

    private List<CustomItem> listItem;
    private ItemValidation iv = new ItemValidation();
    private Context context;

    public AdapterRekonsinyasi(List<CustomItem> listItem, Context context){
    ...
    public PiutangViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_rekonsinyasi, parent, false);
