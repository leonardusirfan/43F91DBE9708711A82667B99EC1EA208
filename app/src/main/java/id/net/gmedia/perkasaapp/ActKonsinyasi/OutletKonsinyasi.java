...
public class OutletKonsinyasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_outlet_konsinyasi);
    ...
    private void initEvent() {
        ...
        lvReseller.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent intent = new Intent(view.getContext(), BarangKonsinyasi.class);
