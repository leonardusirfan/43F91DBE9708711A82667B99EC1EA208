package id.net.gmedia.perkasaapp.ActNGRS;
...
public class DetailNGRSActivity extends AppCompatActivity implements LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_n_g_r_s);

        if(getSupportActionBar() != null){
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setTitle("Order LinkAja NGRS");
        }
    ...
    protected void onResume() {
        ...
        MocLocChecker checker = new MocLocChecker(activity);
    }
    ...
    private void saveData() {
        ...
        ApiVolley request = new ApiVolley(context, jBody, "POST", ServerURL.saveNGRS, new ApiVolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
    ...
    private void getHarga(){
        ...
        ApiVolley request = new ApiVolley(context, jBody, "POST", ServerURL.getHargaNgrs, new ApiVolley.VolleyCallback() {
            @Override
            public void onSuccess(String result) {
